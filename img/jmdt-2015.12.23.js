...
(function(){
	...
	TfBox.createElement = function()
	{
		...
		this.mainStr = "<div style=\"height:"+this.height1+"px; width:"+this.width1+"px; overflow:hidden;position:relative;\"><div id=\"TfMovieFrame\" style=\"height:"+this.height1+"px; width:"+this.width1+"px;\"></div><div id=\"fcClick\" onclick=\"TfBox.getURL()\" onmouseout=\"TfBox.action('close')\" style=\"height:"+this.height1+"px; width:"+this.width1+"px; background:#FC6; cursor:pointer; position:absolute; top:0px; filter:alpha(opacity=0); opacity:0;\"></div><div id=\"fcClose\" onclick=\"TfBox.action('close')\" style=\" position:absolute; bottom:0px; right:0; cursor:pointer;\"><img style=\"vertical-align:bottom\" src=\"xt_close.png\"/*tpa=http://img2.126.net/ntesrich/2015/0831/xt_close.png*//></div></div>"
