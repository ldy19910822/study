	...
	*/
	...
	{		
		if(this.isWidth == 1)
		{
			...
			this.leftBigStr = '<div id="dllbFrame"></div><div id="dllbClickL" onclick="dlBox.getURL()"></div><div id="dllbClose"><img src="x.png"/*tpa=http://img1.126.net/channel7/js/couplet/x.png*/ height="18" width="18" border="0"/></div>';
			...
			this.rightBigStr = '<div id="dlrbFrame"></div><div id="dlrbClickL" onclick="dlBox.getURL()"></div><div id="dlrbClose"><img src="x.png"/*tpa=http://img1.126.net/channel7/js/couplet/x.png*/ height="18" width="18" border="0"/></div>'
			...
			this.left_ad.src = "duilian_left.png"/*tpa=http://img2.126.net/ntesrich/2015/0902/duilian_left.png*/;
			...
			this.right_ad.src = "duilian_right.png"/*tpa=http://img2.126.net/ntesrich/2015/0902/duilian_right.png*/;
